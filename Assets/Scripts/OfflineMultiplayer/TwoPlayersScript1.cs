...
public class TwoPlayersScript1 : MonoBehaviour 
{

	public GameObject Player1, Player2,Player1Button,Player2Button,Maze,PlayerNameMenu,GameMenu,FakePlayer1,FakePlayer2,Waypoint;// Player3, Player4;
...
//				Player2Dice ();
	...
	public void Player2Name(string P2Name)
	{
		NamePlayer2 = P2Name;
	}
